...
///
/// **Bump-to-attack**: if the target tile contains a `Hostile` entity, emits
/// an `AttackIntent` instead of moving. This is the standard roguelike
/// mechanic where walking into an enemy initiates melee combat.
///
...
pub fn movement_system(
    ...
    for intent in intents.read() {
        ...
        // ── Bump-to-attack ──────────────────────────────────────
        // Check if a hostile entity occupies the target tile.
