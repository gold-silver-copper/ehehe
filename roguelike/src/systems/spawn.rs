...
pub const MONSTER_TEMPLATES: &[MonsterTemplate] = &[
    ...
    MonsterTemplate { name: "Coyote", symbol: "c", fg: RatColor::Rgb(220, 170, 100), health: 100, attack: 2, defense: 0, speed: 50, sight_range: 6, exp_reward: 3, faction: Faction::Wildlife, has_gun: false },
    MonsterTemplate { name: "Rattlesnake", symbol: "s", fg: RatColor::Rgb(100, 200, 60), health: 100, attack: 3, defense: 0, speed: 20, sight_range: 8, exp_reward: 5, faction: Faction::Wildlife, has_gun: false },
    // Tier 2: Outlaws (uppercase symbols — human NPCs)
    MonsterTemplate { name: "Outlaw", symbol: "O", fg: RatColor::Rgb(240, 200, 130), health: 100, attack: 4, defense: 0, speed: 34, sight_range: 8, exp_reward: 8, faction: Faction::Outlaws, has_gun: false },
    // Tier 3: Vaqueros (uppercase symbols — human NPCs)
    MonsterTemplate { name: "Vaquero", symbol: "V", fg: RatColor::Rgb(180, 200, 80), health: 100, attack: 5, defense: 0, speed: 32, sight_range: 10, exp_reward: 12, faction: Faction::Vaqueros, has_gun: false },
    // Tier 4: Lawmen (uppercase symbols — human NPCs)
    MonsterTemplate { name: "Cowboy", symbol: "C", fg: RatColor::Rgb(230, 180, 100), health: 100, attack: 6, defense: 0, speed: 30, sight_range: 12, exp_reward: 18, faction: Faction::Lawmen, has_gun: true },
    // Tier 5: Outlaws - Gunslinger (uppercase symbols — human NPCs)
    MonsterTemplate { name: "Gunslinger", symbol: "G", fg: RatColor::Rgb(255, 80, 80), health: 100, attack: 8, defense: 0, speed: 38, sight_range: 14, exp_reward: 30, faction: Faction::Outlaws, has_gun: true },
];
